from agents.function import Function
...
class Actor():
    ...
    def __init__(self, state_shape, action_shape, action_range, tau, batch_size, network_cfg):
        ...
        network_cfg['action_range'] = tf.constant(action_high - action_low, dtype=tf.float32)
        network_cfg['action_low'] = tf.constant(action_low, dtype=tf.float32)
